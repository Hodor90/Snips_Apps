...
def subscribe_intent_callback(hermes, intentMessage):
    ...
    hermes.publish_end_session(intentMessage.session_id, weather.forecast_condition(intentMessage))
...
if __name__ == "__main__":
    ...
    with Hermes(mqtt_options=mqtt_opts) as h:
        h.subscribe_intent("domi:searchWeatherForecastCondition", subscribe_intent_callback).start()
